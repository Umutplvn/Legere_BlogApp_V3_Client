...
<Box sx={{height:"110vh", backgroundColor:"rgb(247, 253, 255)", padding:"6rem 0"}}>
  ...
  <Box sx={profileBox}> 
   ...
   <i className="fa-solid fa-gear" style={revolve? {position:"fixed", right:"20px", fontSize:"1.5rem", transform:"rotate(-180deg)",transitionTimingFunction:"linear",  transition:"2s"}
   
   : {position:"fixed", right:"20px", fontSize:"1.5rem", transform:"rotate(180deg)",transitionTimingFunction:"linear",  transition:"2s", }}
   
   onClick={()=>setRevolve(!revolve)
